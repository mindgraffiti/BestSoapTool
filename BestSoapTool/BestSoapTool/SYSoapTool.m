...
-(void)startSoapTool:(int)__status{
    ...
    [headers setObject:[NSString stringWithFormat:@"%@/%@",soapAction,functionName] forKey:@"SOAPAction"];
...
-(void)callSoapServiceWithoutParameters___soapAction:(NSString*)___soapAction __functionName:(NSString*)___functionName wsdlURL:(NSString*)___url{
    soapAction   =     ___soapAction;
...
-(void)callSoapServiceWithParameters___soapAction:(NSString*)___soapAction __functionName:(NSString*)___functionName tags:(NSMutableArray*)___tags vars:(NSMutableArray*)___vars wsdlURL:(NSString*)___url{
